...
public class displaymhs extends AppCompatActivity {
    ...
    private com.example.exercisesqllite.DBHelper mydb;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mydb = new com.example.exercisesqllite.DBHelper(this);
        ...
        if (extras != null) {
            ...
            if (Value > 0) {
                ...
                String nam = rs.getString(rs.getColumnIndex(com.example.exercisesqllite.DBHelper.MHS_COLUMN_NAMA));
                String pho = rs.getString(rs.getColumnIndex(com.example.exercisesqllite.DBHelper.MHS_COLUMN_PHONE));
                String emaill = rs.getString(rs.getColumnIndex(com.example.exercisesqllite.DBHelper.MHS_COLUMN_EMAIL));
                String alamattt = rs.getString(rs.getColumnIndex(com.example.exercisesqllite.DBHelper.MHS_COLUMN_ALAMAT));
                if (!rs.isClosed()) {
                    rs.close();
                }
